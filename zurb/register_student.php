...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (mysqli_num_rows($email_result) > 0) {
    ...
    $sql_utilizator = "INSERT INTO utilizatori (nume_utilizator, email, parola, tip_utilizator_id,tip_utilizator_meniu_id) VALUES ('$nume', '$email', '$hashed_password', '1','4')";
    ...
    if (mysqli_query($db, $sql_utilizator)) {
      ...
      $sql_student = "INSERT INTO student (utilizatori_id, nume, prenume, email, telefon, facultate, specializare, nr_matricol, parola) VALUES ('$utilizator_id', '$nume', '$prenume', '$email', '$telefon', '$facultate', '$specializare', '$nr_matricol', '$hashed_password')";

      
      if (mysqli_query($db, $sql_student)) {
...
<html class="no-js" lang="en" dir="ltr">
  ...
  <style>
    ...
    .log-in-form input[type="specializare"],
    ...
    <div class="row">
      <div class="column small-centered">
        <div class="button-group">
          <a href="register_student.php" class="button active">Student</a>
          <a href="register_consilier.php" class="button">Consilier</a>
        </div>

        <div class="container">
          <form class="log-in-form" method="POST">
            <h4 class="text-center"><b>Student Registration</b></h4>
          <br>
            ...
            <div>
              <label><b>Specializare</b></label>
              <input type="specializare" name="specializare" required>
            </div>

            <div>
              <label><b>Nr. matricol</b></label>
              <input type="nrmatricol" name="nr_matricol" required>
            </div>
            ...
            <button type="submit" class="button expanded" id="register-button">Register as Student</button>
          </form>
        </div>
      </div>
    </div>
