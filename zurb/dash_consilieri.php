...
<div class="hero-section">
  <div class="hero-section-text">
    ...
    <a href="resurse.php" class=" button" style="text-transform: uppercase;">learn more</a>
  </div>
</div>

<div class="callout primary">
  <h5>Studenții își pot verifica nivelul de stres, anxietate sau depresie cu ajutorul quiz-urilor!</h5>
  <a href="teste.php">Dacă dorești să contribui, apasă aici!</a>
</div>
<br>
<br>
    ...
    <div class="cell">
      <div class="card">
        ...
        <h4>Test - Stres</h4>
          ...
          <a href="quiz.php"> <button type="button" class="button">See quiz</button></li></a>
        </div>
      </div>
    </div>
    <div class="cell">
